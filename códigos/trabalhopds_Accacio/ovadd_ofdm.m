...
saveas(plot1,['ovadd_ofdm-' 'QAM4-n_s-' num2str(n_s) '-N_canais_' num2str(N_canais) '.pdf'])
...
xlabel('SNR')
ylabel('Probabilidade de Erro (%)')
saveas(plot2,['ovadd_ofdm-' 'BPSK-n_s-' num2str(n_s) '-N_canais_' num2str(N_canais) '.pdf'])
